...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/phidl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11220&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/phidl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `phidl` can be installed with:

```
conda install phidl
```

It is possible to list all of the versions of `phidl` available on your platform with:
